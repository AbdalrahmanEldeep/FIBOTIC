...
export const CntForm = () => {
  return (
    <form className='shadow bg-gray-900 dark:bg-slate-800' style={{padding:"15px"}}>
            ...
            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Next</button>
    </form>
  )
}
