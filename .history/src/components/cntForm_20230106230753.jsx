  ...
  return (
    <form className='shadow' style={{padding:"15px"}}>
            <div className="flex flex-col gap-2 items-start mb-6">
                ...
                <select id="countries" required className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
